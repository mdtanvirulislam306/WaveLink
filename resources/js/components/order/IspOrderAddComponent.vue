        ...
        <div class="nk-block-head">
          <div class="nk-block-head-between flex-wrap gap g-2">
            <div class="nk-block-head-content">
              <h2 class="nk-block-title">Add ISP Order </h2>
                <nav>
                  <ol class="breadcrumb breadcrumb-arrow mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add ISP Order</li>
                  </ol>
                </nav>
            </div>
            <div class="nk-block-head-content">
              <ul class="d-flex">
                <li>
                  <router-link to="/isporder" class="btn btn-primary btn-md d-md-none">
                    <em class="icon ni ni-eye"></em>
                    <span>View</span>
                  </router-link>
                </li>
                <li>
                  <router-link to="/isporder" class="btn btn-primary d-none d-md-inline-flex">
                    <em class="icon ni ni-eye"></em>
                    <span>View ISP Order</span>
                  </router-link>
                </li>
              </ul>
            </div>
                        ...
                        <div class="row g-gs">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="productname" placeholder="Service Name">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="baseprice" placeholder="Service price">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                <input type="text" class="form-control" id="discount-price" placeholder="Discount price">
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                <select class="js-select" id="tax-class" data-search="true" data-sort="false">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <div class="row g-gs">
                                <div class="col-lg-6">
                                  <div class="form-control-wrap">
                                    <input type="number" class="form-control" placeholder="On shelf">
                                  </div>
                                </div>
                                <div class="col-lg-6">
                                  <div class="form-control-wrap">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                                <div class="js-quill" data-toolbar="minimal" data-placeholder="Write service description here..."></div>
                              </div>
                            </div>
                          </div>
                          <div class="col-lg-12">
                    ...
                    <div class="card card-gutter-md">
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <div class="form-note mt-3">Set the service media gallery.</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row g-gs">
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <div class="form-note mt-3">Set the service thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted.</div>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">  
